    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    	...
    	http
	        .authorizeHttpRequests((auth) -> auth
                    ...
                    .requestMatchers("/produtos/tipoalimento/vegetariano").permitAll()
                    .requestMatchers("/produtos/tipoalimento/vegano").permitAll()
                    .requestMatchers("/produtos/tipoalimento/tradicional").permitAll()
